...
def get_guaranteed_market_trends(postcode: str) -> Dict[str, Any]:
    ...
    payload = {
        ...
        # INVARIANT: synthetic data must carry 0.0 confidence and is_synthetic flag
        # UI must suppress sparklines and percentage labels when is_synthetic=True
        "confidenceValue": 0.0,
        "is_synthetic": True,
        "ui_display_permitted": False,
        "suppression_reason": "guaranteed_trends_fallback_synthetic_data",
        "signals": {
            "priceGrowth": {
                "trend": "Unknown",
                ...
                "period": "",
                "historicalData": [],
                "source": "No real HPI data available for this area.",
            },
            "rentalDemand": {
                "trend": "Unknown",
                "rental_demand_index": None,
                "period": "",
                "historicalData": [],
                "source": "No real PRMS data available for this area.",
            },
            "futureOutlook": {
                "rating": "Unknown",
                "narrative": "Area data unavailable. Refresh when Land Registry HPI is available for this postcode district.",
                "historicalData": [],
                "source": "Unavailable",
            },
        },
